...
export enum COLUMN {
  ...
  issuedNumberShare = 'issued_number_shared',
...
export enum RELATION {
  ...
  companyHasCurrencies = RELATION_DEFAULT.companyHasCurrencies,
  companyHasOperationCountries = RELATION_DEFAULT.companyHasOperationCountries,
