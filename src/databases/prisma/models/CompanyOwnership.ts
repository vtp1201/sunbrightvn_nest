...
import { ATTRIBUTE, COLUMN, INDEX, INDEX_NAME, RELATION } from '../utils/enums/CompanyOwnership';

export default createModel(MODEL_NAME.COMPANY_OWNERSHIP, (CompanyOwnershipModel) => {
