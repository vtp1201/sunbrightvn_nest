...
import { ATTRIBUTE, COLUMN, RELATION } from '../utils/enums/ChangeRequestStatus';

export default createModel(MODEL_NAME.CHANGE_REQUEST_STATUS, (ChangeRequestStatusModel) => {
