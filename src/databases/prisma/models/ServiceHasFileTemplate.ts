...
import { ATTRIBUTE, COLUMN, RELATION } from '../utils/enums/ServiceHasFileTemplate';

export default createModel(MODEL_NAME.SERVICE_HAS_FILE_TEMPLATE, (ServiceHasFileTemplateModel) => {
  // defined Relations
