...
import { ATTRIBUTE, COLUMN, RELATION } from '../utils/enums/SupportCasePriority';

export default createModel(MODEL_NAME.SUPPORT_CASE_PRIORITY, (SupportCasePriorityModel) => {
